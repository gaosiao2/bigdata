...
if __name__ == '__main__':
    #
    a=Image.open("/data/workspace/myshixun/secret/step1/answer/time_count_top10.png")
    b=Image.open("/data/workspace/myshixun/secret/step1/result/time_count_top10.png")
