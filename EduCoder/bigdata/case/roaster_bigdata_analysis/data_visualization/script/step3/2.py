...
if __name__ == '__main__':
    a=Image.open("/data/workspace/myshixun/secret/step3/answer/monthly_comparison.png")
    b=Image.open("/data/workspace/myshixun/secret/step3/result/monthly_comparison.png")
